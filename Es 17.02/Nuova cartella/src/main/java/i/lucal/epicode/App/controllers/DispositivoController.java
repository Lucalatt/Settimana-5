...
public class DispositivoController {
	...
	public ResponseEntity<Object> postDispositivo(@RequestBody Dispositivo d) {
		Dispositivo dispositivo = ds.saveDispositivo(d);
	...
	public ResponseEntity<Object> update(@PathVariable Integer id, @RequestBody Dispositivo _dispositivo) {
		...
		dispositivo.setTipoD( _dispositivo.getTipoD() );
		ds.save(dispositivo);
